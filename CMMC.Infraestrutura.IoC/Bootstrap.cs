using CMMC.Applications.Services;
...
namespace CMMC.Infraestrutura.IoC
{
    public class Bootstrap
    {
        public static void RegisterServices(Container container)
        {
            ...
            container.Register<IRepositoryBase<Grupo>>(() => new CriacaoAlteracaoRepositoryBase<Grupo>(new GeralContext()), Lifestyle.Scoped);
            container.Register<IUsuarioAppService,UsuarioAppService >(Lifestyle.Scoped);
            container.Register<ICriacaoAlteracaoVMAppServiceBase<Grupo,GrupoViewModel>, CriacaoAlteracaoVMAppServiceBase<Grupo,GrupoViewModel>>(Lifestyle.Scoped);
